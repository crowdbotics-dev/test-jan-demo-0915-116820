...
export const api_v1_example_list = createAsyncThunk(
  "examples/api_v1_example_list",
  async payload => {
    const response = await apiService.api_v1_example_list(payload)
    return response.data
  }
)
export const api_v1_example_create = createAsyncThunk(
  "examples/api_v1_example_create",
  async payload => {
    const response = await apiService.api_v1_example_create(payload)
    return response.data
  }
)
export const api_v1_example_retrieve = createAsyncThunk(
  "examples/api_v1_example_retrieve",
  async payload => {
    const response = await apiService.api_v1_example_retrieve(payload)
    return response.data
  }
)
export const api_v1_example_update = createAsyncThunk(
  "examples/api_v1_example_update",
  async payload => {
    const response = await apiService.api_v1_example_update(payload)
    return response.data
  }
)
export const api_v1_example_partial_update = createAsyncThunk(
  "examples/api_v1_example_partial_update",
  async payload => {
    const response = await apiService.api_v1_example_partial_update(payload)
    return response.data
  }
)
export const api_v1_example_destroy = createAsyncThunk(
  "examples/api_v1_example_destroy",
  async payload => {
...
const examplesSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(api_v1_example_list.pending, (state, action) => {
